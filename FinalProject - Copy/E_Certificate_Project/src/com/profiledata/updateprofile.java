...
public class updateprofile extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String updateSQL = "update updateprofile set  twelpercentage=?,twelMarksheet_No=?,twelPassingYear=?,twelfile=?,bepercentage=?,bePassingYear=?,beMarksheet_No=?,befile=?,mepercentage=?,meMarksheet_No=?,mePassingYear=?,mefile=?  where emailid=?";
			...
			pstmt.setString(6,twelPassingYear );
			pstmt.setString(7,twelMarksheet_No );
			pstmt.setBlob(8, twelinputStream);
			pstmt.setString(9, bepercentage);
			pstmt.setString(10,beMarksheet_No );
			pstmt.setString(11,bePassingYear );
			...
			if (rsid.next()) {
				...
				pstmtid.setBlob(2, idproofinputStream);
				pstmtid.setString(3, emailid);
