...
/**
 * Servlet implementation class companyreject
 */
@WebServlet("/companyreject")
public class companyreject extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public companyreject() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String msg="Your profile is not selected for processing.";
