...
public static void SmartContract(String Email)
{
	String to=Email;
    String subject="Smart Contract";
    String msg="Your Smart Contract Expiry";
   final String user="blockchainecertificate@gmail.com";
   final String pass="sunsoft@123";// send mail qrcode
   Properties props = new Properties();
   props.put("mail.smtp.host", "smtp.gmail.com");
  ...
  message.setText(msg);
   ...
   catch(Exception e) 
   {
	...
	public static void main(String[] args) {
		SmartContract("abhishekbhise37@gmail.com");
