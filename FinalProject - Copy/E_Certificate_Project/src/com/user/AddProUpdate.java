...
//		HttpSession session = request.getSession(false);
		try {
			...
			if (rs.next()) {
				...
				String bemsg="ME";
				String msg="0";
				st.executeUpdate("insert into updateprofile(emailid, firstname, middlename, lastname,address,gender,mobileno,DOB,TwelEducation,twelpercentage,twelMarksheet_No,twelPassingYear,BEEducation,bepercentage,beMarksheet_No,bePassingYear,MEEducation,mepercentage,meMarksheet_No,mePassingYear,twelfile,befile,mefile,Status_Info) values "
						+ "('"
						+ emailid
						+ "','"
						+ firstname
