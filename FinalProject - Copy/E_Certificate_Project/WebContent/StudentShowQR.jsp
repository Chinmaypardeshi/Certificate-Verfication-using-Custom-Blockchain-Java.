...
<td > Transaction</td>
   ...
   <td><a href="CViewIDproof.jsp?emailid=<%= emailid %>"><img style="width: 50px; height: 50px"  src="data:image/jpg;base64, <%=b64%>"/></a></td>
   
          <td width="6%"> <a href="companyinfo?emailid=<%=rs.getString("emailid")%>">View</a></td>
          <td width="6%"> <a href="blockchaintran?emailid=<%=rs.getString("emailid")%>">Transaction</a></td>
           </tr>
					    	<%}
					    		i++;
